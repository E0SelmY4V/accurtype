...
export type Transposed<T extends any[][]> = ArrayLtdSplited<T> extends [infer K2 extends any[], infer K0 extends any[], infer K1 extends any[]] ? TypeAnd<K0 | K1 extends [] ? true : false> extends true
	? LtdTrsed<T> extends { R: infer R extends any[], I: infer I extends RInfo, O: infer O extends number } ? [...R, ...Salt<R, I, O>[]] : [] : PostHdled<K0, K1, LtdTrsed<K2>> : []
