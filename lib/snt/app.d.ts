...
type Leading0Filled<N extends Tostrable, B extends number | `${number}`> = `${B}` extends '0' ? N : `0${Leading0Filled<N, SntXcrUns<9, `${B}`>>}`
declare function fillLeading0<N extends Tostrable, B extends number | `${number}`>(num: N, n0: B): Leading0Filled<N, B>
